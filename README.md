...
```bash
curl -fsSL https://raw.githubusercontent.com/JhonaCodes/env-craft/main/install.sh | VERSION=v0.1.12 bash
```
...
To publish a release, push a semantic version tag such as `v0.1.12`.
